...
// import { DataGrid, GridToolbar, GridFilterModel, GridRowParams, getGridStringOperators, GridFilterOperator, GridFilterItem, GridFilterInputValueProps, GridToolbarContainer, GridToolbarColumnsButton, GridToolbarFilterButton, GridToolbarDensitySelector, GridToolbarExport,GridColDef } from '@mui/x-data-grid'
...
const getClaims = `/api/Claims/getCompletedClaims`
...
const ClaimCallerViewCompletedClaims: React.FC = () => {
    ...
    const [DefaultColumns, setDefaultColumns] = useState({ Bill: true, DateOfService: true,PatientName: true,PayerName: true,ClaimStatus: true,ClaimBilledAmount: true,ClaimPayment: true,ClaimBalance: true,Account: true,ProviderName: true,SystemStatus: true,Aging: true,DueDate: true,Comments: true,updatedAt: true,FirstName: true,Location: false,MemberId: false,PayerMix: false,IntialClaimDate: false,ClaimAdjustemnt: false,Stage: false,RoleResponsibilityCategory: false,DenialReason: false,ServiceType: false,RootCause: false,Modifier: false,PCAStatus : false,ProcedureCode: false,FacilityName: false,PayerResponsibility: false,Indication: false,ProcedureBalance: false,FiledStatus: false,PatientDOB: false,AdjustmentReason: false,CompanyName: false,OrginalICN: false,Diagnosis: false,SecondaryInsuranceCompany: false,DOE: false,Unit: false,ProcedureBilledAmount: false,ProcedurePayment: false,ProcedureAdjustment: false})
    ...
    const fetchData = async () => {
        ...
        if(currentUser.PracticeId.length > 0){
            ...
            if (userDetails) {
                ...
                navigate("/ClaimCallerViewCompletedClaims", { replace: true });
            }
        ...
        <div >
            ...
            >
                <div className='card-title m-0'>
                    <h3 className='fw-bolder m-0'>View Completed Claims</h3>
                </div>
            </div>
            <hr />
...
export { ClaimCallerViewCompletedClaims }