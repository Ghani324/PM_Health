...
const PaymentsBreakDownbyPayer: React.FC = () => {
  ...
  if(PieChartData.length > 0){
    Result = PieChartData.map((res: any, _inde: any) => {
      ...
      GeneeratePieChartData = [res.provider,FilterData[0].payments]
      ...
      <div >
        ...
        >
          <div className='card-title m-0'>
            <h3 className='fw-bolder m-0'>Payments By Payer</h3>
          </div>
        </div>
        <hr />
        <div className='row'>
            ...
            <>
              ...
              {/* <div className='col-sm-4 fv-row'>
                <label className='col-lg-6 col-form-label fw-bold fs-6'>
                  <span className=''>Payer List</span>
                </label>
...
{Result ? <table id='kt_table_users' className='table-row-gray-700 table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer'>
            ...
            <div className="card shadow-sm">
             ...
             {Result ? <div className="card-body">
                <ul>
                  <li>Optimum ,Humana, Medicare ,Ultimate ,UHC are the top 5 Payers contributors in collections, contributes to 78% on the overall collections. Other payers contributes towards 22% Payments</li>
