          ...
          {NcrData.length > 0 ? 
            ...
            <div className="card shadow-sm">
              ...
              <div className="card-body">
                <ul>
                  <li>Water Fall Collection Report is based on the Date Of Service/Month, for the Payments Received in February</li>
                  <li>February’23 Month Collections ($xxx) was received for the Respective Date of Month Services. 99.99% of the claims are received from Dec’22 – Feb’23 (Dates of Services/Months). 100% of the payments spread across -2022-2023 services</li>
                </ul>
              </div>
            </div>
          </div>
